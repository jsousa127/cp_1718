...
\\[\blanklineskip]%
\>[B]{}\Varid{getValidMagicNr}\mathbin{::}\Conid{Block}+(\Conid{Block},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getValidMagicNr}\mathrel{=}\alt{\Varid{cons}\comp (\Varid{id}\times\Varid{nil})}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{rep}\comp (\Varid{cataBlockchain}\;\Varid{getValidMagicNr}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
&   
    \ensuremath{[\mskip1.5mu ([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\mskip1.5mu]}
            \ar[d]_-{\ensuremath{\map \;\Varid{muCounts}}}          
\\
    \ensuremath{\mathit B\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
&
     \ensuremath{[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
