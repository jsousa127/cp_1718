...
=======
\subsubsection*{Dedução de \ensuremath{\conj{\Varid{fk}}{\Varid{lk}}} }
...
>>>>>>> c57cf7c2fa769a67aa98f76cfd23a44408f79c29
\just\equiv{ Eq -+ }
...
\just\equiv{Fokkinga}
    \ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ \comp \p2}}}}

\qed
\end{eqnarray*}

\subsubsection*{Dedução de \ensuremath{\conj{\Varid{g}}{\Varid{s}}} }
\begin{eqnarray*}
\start
        \ensuremath{\begin{lcbr}\Varid{g}\;\mathrm{0}\mathrel{=}\mathrm{1}\\\Varid{g}\;(\Varid{d}\mathbin{+}\mathrm{1})\mathrel{=}(\Varid{d}\mathbin{+}\mathrm{1})\mathbin{*}\Varid{g}\;\Varid{d}\end{lcbr}}
  \more
...
\just\equiv{Fokkinga}
    \ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\succ \comp \p2}}}}

\qed
\end{eqnarray*}

Após a dedução de \begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\conj{\Varid{fk}}{\Varid{lk}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
 e \begin{hscode}\SaveRestoreHook
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\conj{\Varid{g}}{\Varid{s}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
, vamos combinar os resultados utilizando a lei da banana-split:
>>>>>>> c57cf7c2fa769a67aa98f76cfd23a44408f79c29
...
\just\equiv{ for b i = \ensuremath{\Varid{cata}\;\alt{\underline{\Varid{i}}}{\Varid{b}}} }

\ensuremath{\Varid{cata}\;\alt{\underline{\Varid{base}}}{\Varid{loop}}\mathrel{=}\cata{\alt{\conj{\conj{\Varid{one}}{\Varid{mul}\comp \p1}}{\conj{\succ }{\succ \comp \p2\comp \p1}}}{\conj{\conj{\Varid{one}}{\Varid{mul}\comp \p2}}{\conj{\Varid{one}}{\Varid{suc}\comp \p2\comp \p2}}}}}
