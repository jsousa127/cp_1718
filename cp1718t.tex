...
removeRep (a,b) ((c,d) : t) = if (a == c) then (a, b + d) : removeRep (a,b) t   
                                          else (c,d) : removeRep (a,b) t \commentend}{}\<[E]%
\\[\blanklineskip]%
...
rotateQTree = cataQTree rotateQ
          where rotateQ (Left (a, (b, c))) = Cell a c b 
                rotateQ (Right (a,(b,(c,d)))) = Block c a d b \commentend}{}\<[E]%
\\[\blanklineskip]%
...
scaleQTree i (Block a b c d) = Block (scaleQTree i a) (scaleQTree i b) (scaleQTree i c) (scaleQTree i d) \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\mathrel{=}\bot {}\<[E]%
\\[\blanklineskip]%
\>[B]{}\mbox{\commentbegin 
compress n (Block q1 q2 q3 q4)  \ensuremath{(\Varid{n}\mathbin{>}\mathrm{0})\mathrel{=}\Conid{Block}\;(\Varid{compress}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{q1})\;(\Varid{compress}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{q2})\;(\Varid{compress}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{q3})\;(\Varid{compress}\;(\Varid{n}\mathbin{-}\mathrm{1})\;\Varid{q4})} otherwise = compressFolha \commentend}{}\<[E]%
\\[\blanklineskip]%
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\;(i_1\;\Varid{b})\mathrel{=}\Conid{Unit}\;\Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{inFTree}\;(i_2\;(\Varid{a},(\Varid{e},\Varid{d})))\mathrel{=}\Conid{Comp}\;\Varid{a}\;\Varid{e}\;\Varid{d}{}\<[E]%
\\[\blanklineskip]%
