...
\column{20}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inBlockchain}\mathbin{::}(\Conid{Block}\;\Varid{bc})+(\Conid{Block}\;\Varid{bc},\Conid{Blockchain}\;\Varid{a})\to \Conid{Blockchain}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{inBlockchain}\mathrel{=}\alt{\Conid{Bc}}{\uncurry{\Conid{Bcs}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{outBlockchain}\mathbin{::}\Conid{Blockchain}\;\Varid{a}\to (\Conid{Block}\;\Varid{bc})+(\Conid{Block}\;\Varid{bc},\Conid{Blockchain}\;\Varid{a}){}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseBlockchain}\mathbin{::}(\Varid{a}\to \Varid{b})\to (\Varid{c}\to \Varid{d})\to (\Varid{a})+(\Varid{a},\Varid{c})\to (\Varid{b})+(\Varid{b},\Varid{d}){}\<[E]%
\\
\>[B]{}\Varid{baseBlockchain}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{id}+(\Varid{g}\times(\map \;(\Varid{f}\times\Varid{g}))){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBlockchain}\mathbin{::}(\Varid{a}\to \Varid{b})\to (\Varid{d})+(\Varid{d},\Varid{a})\to (\Varid{d})+(\Varid{d},\Varid{a}){}\<[E]%
\\
\>[B]{}\Varid{recBlockchain}\;\Varid{g}\mathrel{=}\Varid{baseBlockchain}\;\Varid{id}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cataBlockchain}\mathbin{::}(((\Varid{a})+(\Varid{a},\Varid{b}))\to \Varid{b})\to \Conid{Blockchain}\;\Varid{a}\to \Varid{b}{}\<[E]%
\\
\>[B]{}\Varid{cataBlockchain}\mathrel{=}\Varid{g}\mathrel{=}\Varid{g}\comp (\Varid{recBlockchain}\;(\Varid{cataBlockchain}\;\Varid{g}))\comp \Varid{outBlockchain}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{anaBlockchain}\mathbin{::}(\Varid{a}\to (\Varid{b})+(\Varid{b},\Varid{a}))\to \Varid{a}\to \Conid{Blockchain}\;\Varid{b}{}\<[E]%
\\
...
\\[\blanklineskip]%
\>[B]{}\Varid{hyloBlockchain}\mathbin{::}{}\<[20]%
\>[20]{}(((\Varid{b})+(\Varid{b},\Varid{c}))\to \Varid{c})\to (\Varid{a}\to (\Varid{b})+(\Varid{b},\Varid{a}))\to \Varid{a}\to \Varid{c}{}\<[E]%
\\
