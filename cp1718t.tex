...
&
    \ensuremath{(\Conid{E}\times(\Conid{V}\times\Conid{E}))\times\Conid{T}\mathbin{*}}
           \ar[d]^-{\cata{(getLedger)}}
\\
     \ensuremath{(\Conid{E}\times\Conid{V})\times\Conid{T}\mathbin{*}}
&
    \ensuremath{(\Conid{E}\times\Conid{V})\times\Conid{T}\mathbin{*}}
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}}
           \ar[d]_-{\ensuremath{\Varid{rotaQTree}}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{QTree}\mathbin{\uparrow}\mathrm{4}}
          \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}} \cata{in.(g+h)}}
          \ar[l]^-{inQTree}
\\
    \ensuremath{\Conid{QTree}}
&
...
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp \Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g}\mathrel{=}(\Varid{id}\times\Varid{swap})+\Varid{h}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}}
           \ar[d]_-{\ensuremath{\Varid{scaleQTree}}}
&
    \ensuremath{\Conid{A}\mathbin{+}\Conid{QTree}\mathbin{\uparrow}\mathrm{4}}
          \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}} \cata{inQTree . g}}
          \ar[l]^-{inQTree}
\\
    \ensuremath{\Conid{QTree}}
&
...
\column{11}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp \Varid{g}){}\<[E]%
\\
\>[B]{}\hsindent{11}{}\<[11]%
\>[11]{}\mathbf{where}\;\Varid{g}\mathrel{=}(\Varid{id}\times((\mathbin{*}\Varid{i})\times(\mathbin{*}\Varid{i})))+\Varid{id}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{QTree}}
           \ar[d]_-{\ensuremath{\Varid{invertQTree}}}
&
    \ensuremath{\Conid{F}\;\Conid{QTree}}
           \ar[l]_-{\ensuremath{\Varid{inQTree}}}
           \ar[d]^-{\ensuremath{\Conid{F}\;\Varid{inverteCor}}}
\\
    \ensuremath{\Conid{QTree}}
...
\\
\>[B]{}\Varid{pruneAux}\;\Varid{n}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{n}\leq \mathrm{1}\mathrel{=}\Conid{Cell}\;(\Varid{cor}\;\Varid{a})\;(\p1\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})))\;(\p2\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{15}{}\<[15]%
\>[15]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Block}\;(\Varid{p}\;\Varid{a})\;(\Varid{p}\;\Varid{b})\;(\Varid{p}\;\Varid{c})\;(\Varid{p}\;\Varid{d}){}\<[E]%
\\
\>[15]{}\hsindent{3}{}\<[18]%
\>[18]{}\mathbf{where}\;\Varid{p}\mathrel{=}\Varid{pruneAux}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
...
\just\equiv{ Igualdade extensional \ensuremath{\times} 2, Def-comp, l k d = \ensuremath{(\Varid{d}\mathbin{+}\Varid{k}\mathbin{+}\mathrm{1})}}
...
\just\equiv{Fokkinga}
    \ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ \comp \p2}}}}
\qed
\end{eqnarray*}
...
\just\equiv{ Igualdade extensional \ensuremath{\times} 2, Def-comp, s d = (d + 1), Cancelamento-x (no s)}
...
Para gerar uma árvore de pitágoras é necessário ter atenção ao tamanho dos quadrados que serão desenhados. Assim, é aplicado um anamorfismo que recebe um gene que vai elevando a \ensuremath{\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})} ao sucessor da ordem de forma a que os quadrados vão diminuindo o seu tamanho ao serem gerados. 
