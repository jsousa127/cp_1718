...
\\
\>[B]{}\Varid{outBlockchain}\;(\Conid{Bcs}\;(\Varid{bc},\Varid{a}))\mathrel{=}i_2\;(\Varid{bc},\Varid{a}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{baseBlockchain}\;\Varid{f}\;\Varid{g}\mathrel{=}\Varid{id}+\Varid{f}\times\Varid{g}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recBlockchain}\;\Varid{g}\mathrel{=}\Varid{baseBlockchain}\;\Varid{id}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Blockchain})}
           \ar[d]^-{\ensuremath{\Varid{id}\mathbin{+}\Varid{id}\times}\cata{(getTransactions)}}
\\
     \ensuremath{\Conid{Transactions}}
&
     \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Transactions})}
           \ar[l]^-{\ensuremath{\Varid{getTransactions}}}
}
\end{eqnarray*}
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getTransactions}\mathbin{::}\Conid{Block}+(\Conid{Block},\Conid{Transactions}){}\<[56]%
\>[56]{}\to \Conid{Transactions}{}\<[E]%
\\
\>[B]{}\Varid{getTransactions}\mathrel{=}\alt{\p2\comp \p2}{\mathsf{conc}\comp ((\p2\comp \p2)\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{allTransactions}\mathrel{=}\Varid{cataBlockchain}\;\Varid{getTransactions}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\Conid{Blockchain}}
           ...
           \ar[r]_-{\ensuremath{\Varid{allTransactions}}}
&
    \ensuremath{\Conid{Block}\mathbin{+}(\Conid{Block}\times\Conid{Blockchain})}
           \ar[d]^-{\cata{(getLedger)}}
\\
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ledger}\mathrel{=}\Varid{acc}\comp (\Varid{cataList}\;\Varid{getLedger})\comp \Varid{allTransactions}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{acc}\mathbin{::}\Conid{Ledger}\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{acc}\mathrel{=}\map \;(\Varid{id}\times\Varid{sum})\comp \Varid{col}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{getLedger}\mathbin{::}()+(\Conid{Transaction},\Conid{Ledger})\to \Conid{Ledger}{}\<[E]%
\\
\>[B]{}\Varid{getLedger}\;(i_1\;\Varid{b})\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getLedger}\;(i_2\;((\Varid{a},(\Varid{c},\Varid{d})),\Varid{t}))\mathrel{=}[\mskip1.5mu (\Varid{a},\mathbin{-}\Varid{c})\mskip1.5mu]\plus [\mskip1.5mu (\Varid{d},\Varid{c})\mskip1.5mu]\plus \Varid{t}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{getMagicNr}\mathbin{::}\Conid{Block}+(\Conid{Block},[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu])\to [\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{getMagicNr}\mathrel{=}\alt{\Varid{singl}\comp (\Varid{id}\comp \p1)}{\Varid{cons}\comp (\p1\times\Varid{id})}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{rep}\mathbin{::}[\mskip1.5mu \Conid{MagicNo}\mskip1.5mu]\to \Conid{Bool}{}\<[E]%
\\
\>[B]{}\Varid{rep}\mathrel{=}\uncurry{(\equiv )}\comp \conj{\Varid{id}}{\Varid{nub}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{isValidMagicNr}\mathrel{=}\Varid{rep}\comp (\Varid{cataBlockchain}\;\Varid{getMagicNr}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inQTree}\;(i_1\;(\Varid{a},(\Varid{b},\Varid{c})))\mathrel{=}\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c}{}\<[E]%
\\
\>[B]{}\Varid{inQTree}\;(i_2\;(\Varid{b},(\Varid{c},(\Varid{d},\Varid{e}))))\mathrel{=}\Conid{Block}\;\Varid{b}\;\Varid{c}\;\Varid{d}\;\Varid{e}{}\<[E]%
\\[\blanklineskip]%
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{h}\mathrel{=}\conj{\p1\comp \p2\comp \p2}{\conj{\p1}{\conj{\p2\comp \p2\comp \p2}{\p1\comp \p2}}}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{rotateQTree}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times\Varid{swap})+\Varid{h})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{scaleQTree}\;\Varid{i}\mathrel{=}\Varid{cataQTree}\;(\Varid{inQTree}\comp ((\Varid{id}\times((\mathbin{*}\Varid{i})\times(\mathbin{*}\Varid{i})))+\Varid{id})){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{invertQTree}\mathrel{=}\mathsf{fmap}\;\Varid{inverteCor}{}\<[E]%
\\
\>[B]{}\hsindent{13}{}\<[13]%
\>[13]{}\mathbf{where}\;\Varid{inverteCor}\;(\Conid{PixelRGBA8}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Conid{PixelRGBA8}\;(\mathrm{255}\mathbin{-}\Varid{a})\;(\mathrm{255}\mathbin{-}\Varid{b})\;(\mathrm{255}\mathbin{-}\Varid{c})\;\Varid{d}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{28}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{compressQTree}\;\Varid{n}\;\Varid{t}\mathrel{=}\Varid{pruneAux}\;((\Varid{depthQTree}\;\Varid{t})\mathbin{-}(\Varid{n}\mathbin{-}\mathrm{1}))\;\Varid{t}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pruneAux}\mathbin{::}\Conid{Int}\to \Conid{QTree}\;\Varid{a}\to \Conid{QTree}\;\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{pruneAux}\;\Varid{n}\;(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y})\mathrel{=}(\Conid{Cell}\;\Varid{a}\;\Varid{x}\;\Varid{y}){}\<[E]%
\\
\>[B]{}\Varid{pruneAux}\;\Varid{n}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mid \Varid{n}\leq \mathrm{1}\mathrel{=}\Conid{Cell}\;(\Varid{cor}\;\Varid{a})\;(\p1\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})))\;(\p2\;(\Varid{sizeQTree}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d}))){}\<[E]%
\\
\>[B]{}\hsindent{28}{}\<[28]%
\>[28]{}\mid \Varid{otherwise}\mathrel{=}\Conid{Block}\;(\Varid{p}\;\Varid{a})\;(\Varid{p}\;\Varid{b})\;(\Varid{p}\;\Varid{c})\;(\Varid{p}\;\Varid{d}){}\<[E]%
\\
\>[B]{}\hsindent{22}{}\<[22]%
\>[22]{}\mathbf{where}\;\Varid{p}\mathrel{=}\Varid{pruneAux}\;(\Varid{n}\mathbin{-}\mathrm{1}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{cor}\mathbin{::}\Conid{QTree}\;\Varid{a}\to \Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{cor}\;(\Conid{Cell}\;\Varid{a}\;\Varid{b}\;\Varid{c})\mathrel{=}\Varid{a}{}\<[E]%
\\
\>[B]{}\Varid{cor}\;(\Conid{Block}\;\Varid{a}\;\Varid{b}\;\Varid{c}\;\Varid{d})\mathrel{=}\Varid{cor}\;\Varid{a}{}\<[E]%
\\[\blanklineskip]%
...
\start
  ...
  \just\equiv{ Igualdade extensional \ensuremath{\times} 2, Def-comp, l k d = (d + k  + 1)}
        ...
        \ensuremath{\begin{lcbr}\Varid{l}\;\Varid{k}\comp \Varid{zero}\mathrel{=}\succ \\\Varid{l}\;\Varid{k}\comp \succ \mathrel{=}\succ \comp \Varid{l}\;\Varid{k}\end{lcbr}}
...
\just\equiv{ Eq -+ }
  ...
  \more
    \ensuremath{\alt{\Varid{l}\;\Varid{k}\comp \Varid{zero}}{\Varid{l}\;\Varid{k}\comp \succ }\mathrel{=}\alt{\succ }{\succ \comp \Varid{l}\;\Varid{k}}}
...
\just\equiv{ Fusão -+ (esq), Absorção -+ (dir)}
  ...
  \more
    \ensuremath{\Varid{l}\;\Varid{k}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\succ }{\succ }\comp (\Varid{id}\mathbin{+}\Varid{lk})}

\just\equiv{Fokkinga}
    \ensuremath{\conj{\Varid{f}\;\Varid{k}}{\Varid{l}\;\Varid{k}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ }}}}
...
\just\equiv{ Igualdade extensional \ensuremath{\times} 2, Def-comp, s d = (d + 1)}
...
\just\equiv{ Eq -+ }
  ...
  \more
    \ensuremath{\alt{\Varid{s}\comp \Varid{zero}}{\Varid{s}\comp \succ }\mathrel{=}\alt{\Varid{one}}{\succ \comp \Varid{s}}}

\just\equiv{ Fusão -+ (esq), Absorção -+ (dir)}
    \ensuremath{\Varid{g}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}\mathbin{+}\conj{\Varid{s}}{\Varid{g}})}
  \more
    \ensuremath{\Varid{l}\;\Varid{k}\comp \alt{\Varid{zero}}{\succ }\mathrel{=}\alt{\Varid{one}}{\succ }\comp (\Varid{id}\mathbin{+}\Varid{s})}

\just\equiv{Fokkinga}
    \ensuremath{\conj{\Varid{g}}{\Varid{s}}\mathrel{=}}\cata{\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\succ }}}}
...
\begin{eqnarray*}
\start
  \ensuremath{\conj{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ }}}}{\cata{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\Varid{suc}}}}}}

\just\equiv{Banana-Split}
  \more
  \ensuremath{\cata{(\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ }}}}><\ensuremath{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\Varid{suc}}}\comp \conj{\Conid{F}\;\p1}{\Conid{F}\;\p2})}

\just\equiv{Absorção - x}
  \more
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\succ }{\succ }}\comp (\Conid{F}\;\p1)}{\conj{\alt{\Varid{one}}{\Varid{mul}}}{\alt{\Varid{one}}{\Varid{suc}}}\comp (\Conid{F}\;\p2)}}}

\just\equiv{Fusão - x}
  \more
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp (\Conid{F}\;\p1)}{\alt{\succ }{\succ }\comp (\Conid{F}\;\p1)}}{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp (\Conid{F}\;\p2)}{\alt{\Varid{one}}{\Varid{suc}}\comp (\Conid{F}\;\p2)}}}}

\just\equiv{Def F f = id + f}
  \more
  \ensuremath{\cata{\conj{\conj{\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}}{\cdot }}{\cdot }}}-\ensuremath{\mathbin{-}} p1)) ((either succ succ) . (id \ensuremath{\mathbin{-}}-\ensuremath{\p1)))\;\conj{\alt{\Varid{one}}{\Varid{mul}}\comp (\Varid{id}}{\cdot }}-\ensuremath{\mathbin{-}} p2)) ((either one suc) . (id \ensuremath{\mathbin{-}}-\ensuremath{\p2))))}
...
\column{13}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{base}\mathrel{=}\Varid{f}\comp \conj{\Varid{a}}{\Varid{b}}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{a}\mathrel{=}\conj{\Varid{one}}{\succ }{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{b}\mathrel{=}\conj{\Varid{one}}{\Varid{one}}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{f}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{loop}\mathrel{=}\Varid{f}\comp \conj{\Varid{a}}{\Varid{b}}\comp \Varid{h}{}\<[E]%
\\
\>[B]{}\hsindent{7}{}\<[7]%
\>[7]{}\mathbf{where}\;\Varid{a}\mathrel{=}\conj{\Varid{mul}\comp \p1}{\succ \comp \p2\comp \p1}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{b}\mathrel{=}\conj{\Varid{mul}\comp \p2}{\succ \comp \p2\comp \p2}{}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{h}\;(\Varid{a},\Varid{b},\Varid{c},\Varid{d})\mathrel{=}((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d})){}\<[E]%
\\
\>[7]{}\hsindent{6}{}\<[13]%
\>[13]{}\Varid{f}\;((\Varid{a},\Varid{b}),(\Varid{c},\Varid{d}))\mathrel{=}(\Varid{a},\Varid{b},\Varid{c},\Varid{d}){}\<[E]%
\ColumnHook
...
\column{5}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{inFTree}\mathrel{=}\alt{\Conid{Unit}}{\Varid{uncomp}\comp \Varid{assocl}}{}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{uncomp}\mathrel{=}\uncurry{\uncurry{\Conid{Comp}}}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{baseFTree}\;\Varid{g}\;\Varid{h}\;\Varid{k}\mathrel{=}\Varid{h}+(\Varid{g}\times(\Varid{k}\times\Varid{k})){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{recFTree}\;\Varid{g}\mathrel{=}\Varid{baseFTree}\;\Varid{id}\;\Varid{id}\;\Varid{g}{}\<[E]%
\\[\blanklineskip]%
...
\\[\blanklineskip]%
\>[B]{}\Varid{generatePTree}\mathrel{=}\Varid{anaFTree}\;((\underline{\mathrm{1.0}}+\conj{((\Varid{sqrt}\;(\mathrm{2})\mathbin{/}\mathrm{2})\mathbin{\uparrow})\comp \succ }{\conj{\Varid{id}}{\Varid{id}}})\comp \Varid{outNat}){}\<[E]%
\\[\blanklineskip]%
...
&
    \ensuremath{(\Varid{a},\underline{\mathrm{1}})}
           \ar[d]_-{\ensuremath{\Varid{singl}}}
\\
     \ensuremath{\mathit B\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
&
...
\begin{eqnarray*}
\xymatrix@C=2cm{
    \ensuremath{\mathit B\;[\mskip1.5mu (\mathit B\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\mu }}
           \ar[r]_-{\ensuremath{\mathsf{fmap}\;\Varid{unB}}}
&
    \ensuremath{\mathit B\;[\mskip1.5mu ([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\mskip1.5mu]}
           \ar[r]_-{\ensuremath{\Varid{unB}}}
&   
    \ensuremath{[\mskip1.5mu ([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\mskip1.5mu]}
            \ar[d]^-{\ensuremath{\map \;\Varid{muCounts}}}          
\\
    \ensuremath{\mathit B\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
&
     \ensuremath{[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
...
\ensuremath{[\mskip1.5mu [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]\mskip1.5mu]}
            \ar[l]_-{\ensuremath{\Varid{concat}}}
}
\end{eqnarray*}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\mu \mathrel{=}\mathit B\comp \Varid{concat}\comp (\map \;\Varid{muCounts})\comp \Varid{unB}\comp (\mathsf{fmap}\;\Varid{unB}){}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\xymatrix@C=2cm{
    \ensuremath{\mathit B\;[\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]}
           \ar[d]_-{\ensuremath{\Varid{dist}}}
           \ar[r]_-{\ensuremath{\Varid{genDist}}}
 &
    \ensuremath{[\mskip1.5mu (\Varid{a},\Conid{ProbRep})\mskip1.5mu]}
           \ar[dl]_-{\ensuremath{\Conid{D}}}
\\
    \ensuremath{\Conid{D}\;[\mskip1.5mu (\Varid{a},\Conid{ProbRep})\mskip1.5mu]} 
&   
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{dist}\mathrel{=}\Conid{D}\comp \Varid{genDist}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{muCounts}\mathbin{::}([\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu],\Conid{Int})\to [\mskip1.5mu (\Varid{a},\Conid{Int})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{muCounts}\;(\Varid{l},\Varid{n})\mathrel{=}\map \;(\Varid{id}\times(\Varid{n}\mathbin{*}))\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{genDist}\mathbin{::}\Conid{Bag}\;\Varid{a}\to [\mskip1.5mu (\Varid{a},\Conid{ProbRep})\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{genDist}\;\Varid{bag}\mathrel{=}\map \;(\lambda (\Varid{a},\Varid{n})\to (\Varid{a},\Varid{fromIntegral}\;\Varid{n}\mathbin{/}\Varid{fromIntegral}\;\Varid{t}))\;(\Varid{unB}\;(\Varid{bag})){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{t}\mathrel{=}\Varid{count}\;\Varid{bag}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{calcProb}\mathbin{::}(\Varid{a},\Conid{Int})\to \Conid{Int}\to (\Varid{a},\Conid{ProbRep}){}\<[E]%
\\
\>[B]{}\Varid{calcProb}\;(\Varid{a},\Varid{n})\;\Varid{i}\mathrel{=}(\Varid{a},\Varid{nn}\mathbin{/}\Varid{ii}){}\<[E]%
\\
\>[B]{}\hsindent{3}{}\<[3]%
\>[3]{}\mathbf{where}\;\Varid{nn}\mathrel{=}\Varid{fromIntegral}\;\Varid{n}{}\<[E]%
\\
\>[3]{}\hsindent{6}{}\<[9]%
\>[9]{}\Varid{ii}\mathrel{=}\Varid{fromIntegral}\;\Varid{i}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{count}\mathbin{::}\Conid{Bag}\;\Varid{b}\to \Conid{Int}{}\<[E]%
\\
\>[B]{}\Varid{count}\mathrel{=}\Varid{sum}\comp (\map \;\p2)\comp \Varid{unB}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
